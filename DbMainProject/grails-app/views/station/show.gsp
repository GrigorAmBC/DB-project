...
<html>
    ...
    <body>
        ...
        <div id="show-station" class="content scaffold-show" role="main">
            ...
            <f:display bean="station" />
            <g:form resource="${this.station}" method="DELETE">
                <fieldset class="buttons">
                    <g:link class="edit" action="edit" resource="${this.station}"><g:message code="default.button.edit.label" default="Edit" /></g:link>
