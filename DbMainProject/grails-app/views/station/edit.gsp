...
<html>
    ...
    <body>
        ...
        <div id="edit-station" class="content scaffold-edit" role="main">
            ...
            <g:hasErrors bean="${this.station}">
            <ul class="errors" role="alert">
                <g:eachError bean="${this.station}" var="error">
                <li <g:if test="${error in org.springframework.validation.FieldError}">data-field-id="${error.field}"</g:if>><g:message error="${error}"/></li>
                </g:eachError>
            </ul>
            </g:hasErrors>
            <g:form resource="${this.station}" method="PUT">
                <g:hiddenField name="version" value="${this.station?.version}" />
                <fieldset class="form">
                    <f:all bean="station"/>
                </fieldset>
