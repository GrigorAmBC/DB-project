...
class BootStrap {
    ...
    def init = { servletContext ->
        ...
        new Team(department: d2, createdAt: getDate(2015, 2, 2), budget: 10000, name: "team2", isWorking: true).save()
        new Team(department: d1, createdAt: getDate(2020, 11, 3), budget: 41234, name: "team3", isWorking: true).save()
        new Team(department: d3, createdAt: getDate(2005, 12, 15), budget: 29201, name: "team4", isWorking: false).save()
        new Team(department: d4, createdAt: getDate(2000, 7, 21), budget: 120, name: "team5", isWorking: false).save()
    }
    def destroy = {
    }
